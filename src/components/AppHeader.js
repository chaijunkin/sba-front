...
{/* {
                        isLoggedIn ? (
                            <div className="header-right">
                                <Link type="button" className="btn btn-success" to="/redeemption-history">
                                    <i className="fas fa-redeemption-history" />&nbsp; Redeemption History 
                                    <span className="sr-only">redeemption items</span>
                                </Link>
                            </div>
                        ) : (<div></div>)
                    }
